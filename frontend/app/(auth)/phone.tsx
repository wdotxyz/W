...
const styles = StyleSheet.create({
  ...
  country: { backgroundColor: colors.surface2, borderRadius: radius.lg, paddingHorizontal: 14, justifyContent: "center", minWidth: 80 },
  countryInput: { fontSize: 18, color: colors.text, fontWeight: "600" },
